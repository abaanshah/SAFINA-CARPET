      ...
      <div className="p-4 flex flex-col flex-grow">
        <h3 className="text-base font-semibold text-gray-800 truncate">
          <Link
            ...
            className="hover:text-[#5c0b0a] transition-colors"
          >
            {product.name}
          </Link>
        </h3>
    ...
    <div className="space-y-8">
      {Object.entries(availableFilters).map(
        ([key, options], index) =>
          options.length > 0 && (
            ...
            >
              <h3 className="font-semibold capitalize mb-3 text-gray-800 border-b pb-2">
                {key}
              </h3>
              <div className="space-y-2 max-h-60 overflow-y-auto pr-2">
                {options.map((option) => (
                  <button
                    ...
                    className={`block w-full text-left text-sm transition-colors rounded-md px-3 py-1.5 ${
                      filters[key] === option
                        ? "bg-[#5c0b0a] text-white font-semibold"
      ...
      >
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-100 transition text-sm"
        >
            ...
            <div className="flex justify-between items-center mb-4 border-b pb-4">
              ...
              <div className="flex items-center gap-4">
                <select
                  ...
                  value={sortBy}
                  className="px-4 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-[#5c0b0a] outline-none transition bg-white"
                >
                ...
                <button
                  className="lg:hidden flex items-center gap-2 px-4 py-2 border rounded-md text-sm font-semibold"
                ...
                <AnimatePresence>
                  {filteredAndSortedProducts.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-24 flex flex-col justify-center items-center bg-gray-50 rounded-lg border">
                      ...
                      <button
                        onClick={clearFilters}
                        className="mt-6 px-5 py-2 bg-[#5c0b0a] text-white rounded-md hover:bg-[#4a0908] transition"
                      >
                        Clear Filters
                      </button>
                    </div>
        ...
        {isMobileFilterOpen && (
          ...
          >
            <motion.div
              ...
              className="absolute top-0 left-0 h-full w-4/5 max-w-sm bg-gray-50 p-6 overflow-y-auto"
