...
const Dashboard = () => {
  ...
  const personalInfoFields = [
    { id: "firstName", label: "First Name", type: "text", colSpan: "col-span-1" },
    { id: "lastName", label: "Last Name", type: "text", colSpan: "col-span-1" },
    {
      id: "email", label: "Email Adderess", type: "email",
      colSpan: "col-span-1", defaultValue: "", bgColor: "bg-[#c8c3c3]"
    },
    { id: "mobile", label: "Mobile Number", type: "tel", colSpan: "col-span-1" },
  ...
  const shippingAddressFields = [
    ...
    { id: "region", label: "Region/State/Province", type: "text", colSpan: "col-span-1" },
  ];

  return (
    <div className="bg-white flex flex-row justify-center w-full" data-model-id="60572:9770">
        ...
        <main className="w-full bg-[#fbf1f0] border-t-[5px] border-[#8c3131] flex flex-col">
          ...
          <Tabs defaultValue="address" className="mt-8 mx-4 sm:mx-8 md:mx-[68px]">
            ...
            <TabsContent value="communication">
              <div className="py-8">
                <p className="text-center">Communication/watchlist content will go here</p>
              </div>
            </TabsContent>
          </Tabs>
