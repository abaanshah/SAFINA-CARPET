      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card className="border-border">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">3.9% of total</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">52.1% return rate</p>
          </CardContent>
        </Card>
      </div>
            ...
            <TableBody>
              {filteredCustomers.map((customer) => (
                <TableRow key={customer.id} className="border-border">
                  ...
                  <TableCell className="text-card-foreground">
                    <Badge variant="outline">{customer.wishlist.length} items</Badge>
                  </TableCell>
                  <TableCell>
                    <Badge
                      className={
