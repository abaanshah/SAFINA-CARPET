...
export default function CustomerFavorites() {
  ...
  const filteredFavorites = favorites.filter((favorite) => {
    const matchesSearch =
      favorite.customerName.toLowerCase().includes(searchTerm.toLowerCase()) ||
      favorite.productName.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesCategory =
      filterCategory === "all" || favorite.productCategory === filterCategory;
                ...
                <TableRow key={favorite.id} className="border-border">
                  ...
                  <TableCell>
                    <Badge className={getPriorityColor(favorite.priority)}>
                      {favorite.priority.charAt(0).toUpperCase() +
                        favorite.priority.slice(1)}
                    </Badge>
                  </TableCell>
                  <TableCell className="text-card-foreground">
                            ...
                            <div className="space-y-4">
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <p className="text-card-foreground">
                                    {selectedFavorite.customerName}
                                  </p>
                                  <p className="text-sm text-muted-foreground">
                                    {selectedFavorite.customerEmail}
                                  </p>
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <p className="text-card-foreground">
                                    {selectedFavorite.productCategory}
                                  </p>
                                </div>
                                <div>
                                  <label className="text-sm font-medium text-muted-foreground">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <p className="text-card-foreground">
                                    {formatDate(selectedFavorite.dateAdded)}
                                  </p>
                                </div>
                                <div>
                                  <label className="text-sm font-medium text-muted-foreground">
                                  ...
                                  <Badge
                                    className={getPriorityColor(
                                      selectedFavorite.priority
                                    )}
                                  >
                                    {selectedFavorite.priority
                                      .charAt(0)
                                      .toUpperCase() +
                                      selectedFavorite.priority.slice(1)}
                                  </Badge>
                                </div>
                              </div>
