// ===================================================================
// FILE: src/pages/Cart/Cart.jsx (Final Version)
// ===================================================================
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 p-6 bg-white">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-xl font-semibold text-gray-900" style={{ fontFamily: "Jost, sans-serif" }}>
                Your Shopping Cart
              </h2>
            </div>
            <button
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mb-3 capitalize">{item.size} &bull; {item.color}</p>
                        </div>
                        <button onClick={() => removeItem(item._id)} className="p-1 text-gray-400 hover:text-red-600 transition-colors">
