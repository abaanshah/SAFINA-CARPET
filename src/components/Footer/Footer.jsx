...
export const Footer = () => {
  return (
    <footer  className="" style={{ backgroundColor: "#FFE5E6" }}>
      {/* Main Footer Content */}
      <div className="max-w-7xl mx-auto px-4 py-12 h-[550px]  ">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-gray-700 italic underline mb-4">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    href="#"
                    className="w-10 h-10 bg-red-800 rounded-full flex items-center justify-center text-white hover:bg-red-700 transition-colors"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
      ...
      <div className="bg-red-900 text-white py-4 ">
        <div className="max-w-7xl mx-auto px-4 ">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm">
              ©2025 Safinacarpets.Com | All Rights Reserved | Powered By : Pixel
              Digital
            </p>
